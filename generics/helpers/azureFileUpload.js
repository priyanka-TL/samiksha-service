...
//   process.env.AZURE_ACCOUNT_NAME && process.env.AZURE_ACCOUNT_NAME != '' ? process.env.AZURE_ACCOUNT_NAME : '';
// const AZURE_ACCOUNT_KEY =
//   process.env.AZURE_ACCOUNT_KEY && process.env.AZURE_ACCOUNT_KEY != '' ? process.env.AZURE_ACCOUNT_KEY : '';

// // The name of the container that the files will be uploaded to.
// const AZURE_STORAGE_CONTAINER =
//   process.env.AZURE_STORAGE_CONTAINER && process.env.AZURE_STORAGE_CONTAINER != ''
...
//   blobServiceClient = new BlobServiceClient(`https://${AZURE_ACCOUNT_NAME}.blob.core.windows.net`, sharedKeyCredential);
