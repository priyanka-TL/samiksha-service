module.exports = {
  ...
  ASSESSMENT_BLOCK_FOR_RATING:
    'Sorry! This could be because the assessment has been blocked. Resolve conflicts to proceed further.',
  ...
  USER_ORGANISATION_DETAILS_NOT_FOUND:
    'Cannot create an observation for user whose organisation details are not available',
  ...
  ORGANISATION_DETAILS_NOT_FOUND_FOR_USER:
    'Cannot create an survey for user whose organisation details are not available',
  SUBMISSION_STATUS_FETCHED: 'Submission status fetched successfully',
  ...
  PROGRAM_SCOPE_NOT_ADDED: 'Program scope not added',
