...
module.exports = class MediaFiles extends Abstract {
  ...
  createEmoji(req) {
    return new Promise(async (resolve, reject) => {
      try {
        let result = await mediaFilesHelper.createEmoji(req.body.name, req.body.unicode, req.userDetails.userId);
  ...
  createGesture(req) {
    return new Promise(async (resolve, reject) => {
      try {
        let result = await mediaFilesHelper.createGesture(req.body.name, req.body.unicode, req.userDetails.userId);
  ...
  getGesture(req) {
    return new Promise(async (resolve, reject) => {
      try {
        let gestureDocument = await mediaFilesHelper.getGesture(req.body.name);
  ...
  getEmoji(req) {
    return new Promise(async (resolve, reject) => {
      try {
        let emojiDocument = await mediaFilesHelper.getEmoji(req.body.name);
