...
module.exports = class SurveysHelper {
  ...
  static importSurveryTemplateToSolution(solutionId = '', userId = '', appName = '',tenantAndOrgInfo, programId,userToken) {
    return new Promise(async (resolve, reject) => {
      try {
        if (solutionId == '') {
  ...
  static getDetailsByLink(link = '', userId = '', token = '', roleInformation = {}, version = '',tenantData) {
    return new Promise(async (resolve, reject) => {
      try {
        if (link == '') {
  ...
  static detailsV3(bodyData, surveyId = '', solutionId = '', userId = '', token = '',tenantData,fromPrjectService=false) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        let surveyDetails = await this.details(surveyData.data, userId, validateSurvey.data.submissionId, bodyData,token,tenantData);
  ...
  static getLink(solutionId, appName,tenantData) {
    return new Promise(async (resolve, reject) => {
      try {
