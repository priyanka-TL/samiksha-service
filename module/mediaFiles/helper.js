...
module.exports = class MediaFilesHelper {
  ...
  static mediaFileDocuments(mediaFileFilter = 'all', fieldsArray = 'all', skipFields = 'none') {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        let mediaFileDocuments = await database.models.mediaFiles.find(queryObject, projection).lean();
  ...
  static getEmoji(name = '') {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        let emojiDocument = await this.mediaFileDocuments(queryObject, ['name', 'unicode', 'type', 'status']);
  ...
  static getGesture(name = '') {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        let gestureDocument = await this.mediaFileDocuments(queryObject, ['name', 'unicode', 'type', 'status']);
