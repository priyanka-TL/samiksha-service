        ...
        await Promise.all(
          submissionDocuments.map(async (eachSubmissionDocument) => {
            ...
            if (allSubmittedEvidence) {
                    ...
                    if (criteria.rubric.expressionVariables && allCriteriaLevels) {
                      ...
                      const questionAndCriteriaValueExtractor = function (questionOrCriteria) {
                        ...
                        if (_.includes(questionOrCriteriaArray, 'entityProfile')) {
                          if (
                            eachSubmissionDocument.entityProfile &&
                            eachSubmissionDocument.entityProfile[questionOrCriteriaArray[1]]
                          ) {
                        ...
                        if (
                          questionOrCriteriaArray.findIndex((questionOrCriteria) =>
                            _.includes(questionOrCriteria, 'scoreOfAllQuestionInCriteria'),
                          ) >= 0
                        ) {
                          result = 0;

                          let criteriaIdIndex = questionOrCriteriaArray.findIndex(
                            (questionOrCriteria) => !_.includes(questionOrCriteria, 'scoreOfAllQuestionInCriteria'),
                          );
                          ...
                          let allCriteriaQuestions = _.filter(
                            _.values(eachSubmissionDocument.answers),
                            _.matchesProperty('criteriaId', criteriaId),
                          );
                          ...
                          allCriteriaQuestions.forEach((question, questionIndexInArray) => {
                            if (
                              ...
                              let questionOptionsSelected = Array.isArray(question.value)
                                ? question.value
                                : [question.value];
                              if (questionOptionsSelected.length > 0) {
                                ...
                                questionOptionsSelected.forEach((optionValue) => {
                                  if (
                                    eachSubmissionDocument.questionDocuments &&
                                    eachSubmissionDocument.questionDocuments[question.qid.toString()]
                                  ) {
                                    let optionScore = 'NA';

                                    if (
                                      `${optionValue}-score` in
                                      eachSubmissionDocument.questionDocuments[question.qid.toString()]
                                    ) {
                                      optionScore =
                                        eachSubmissionDocument.questionDocuments[question.qid.toString()][
                                      ...
                                      eachSubmissionDocument.questionDocuments[question.qid.toString()].sliderOptions &&
                                      eachSubmissionDocument.questionDocuments[question.qid.toString()].sliderOptions
                                        .length > 0
                                    ) {
                                      let sliderOptionApplicable = _.find(
                                        eachSubmissionDocument.questionDocuments[question.qid.toString()].sliderOptions,
                                        { value: optionValue },
                                      );
                                      optionScore =
                                        sliderOptionApplicable && sliderOptionApplicable.score
                                          ? sliderOptionApplicable.score
                                          : 'NA';
                                    }

                                    if (optionScore != 'NA') {
                                      if (scoreOfAllQuestionInCriteria[question.qid.toString()]) {
                                        scoreOfAllQuestionInCriteria[question.qid.toString()].scoreAchieved +=
                                          optionScore;
                                        scoreOfAllQuestionInCriteria[question.qid.toString()].percentageScore =
                                          eachSubmissionDocument.questionDocuments[question.qid.toString()].maxScore >
                                            0 && scoreOfAllQuestionInCriteria[question.qid.toString()].score
                                            ? (scoreOfAllQuestionInCriteria[question.qid.toString()].score /
                                                eachSubmissionDocument.questionDocuments[question.qid.toString()]
                                                  .maxScore) *
                                              100
                                            : 0;
                                ...
                                if (selectedOptionScoreFound) {
                                  totalWeightOfQuestionInCriteria +=
                                    eachSubmissionDocument.questionDocuments[question.qid.toString()].weightage ||
                                    eachSubmissionDocument.questionDocuments[question.qid.toString()].weightage === 0
                                      ? eachSubmissionDocument.questionDocuments[question.qid.toString()].weightage
                                      : 1;
                                }
                                if (selectedOptionScoreFound) {
                                  question.optionScores =
                                    eachSubmissionDocument.questionDocuments[question.qid.toString()];
                                  question.optionScores.percentageScore =
                                    eachSubmissionDocument.questionDocuments[question.qid.toString()].maxScore > 0 &&
                                    scoreOfAllQuestionInCriteria[question.qid.toString()].scoreAchieved
                                      ? (scoreOfAllQuestionInCriteria[question.qid.toString()].scoreAchieved /
                                          eachSubmissionDocument.questionDocuments[question.qid.toString()].maxScore) *
                                        100
                                      : 0;
                                  question.optionScores.scoreAchieved = scoreOfAllQuestionInCriteria[
                          ...
                          if (
                            totalWeightOfQuestionInCriteria > 0 &&
                            Object.keys(scoreOfAllQuestionInCriteria).length > 0
                          ) {
                            let criteriaMaxScore = 0;
                            let criteriaScoreAchieved = 0;
                            Object.keys(scoreOfAllQuestionInCriteria).forEach((questionId) => {
                              const questionPointsBasedScore =
                                (scoreOfAllQuestionInCriteria[questionId].scoreAchieved *
                                  scoreOfAllQuestionInCriteria[questionId].weightage) /
                                totalWeightOfQuestionInCriteria;
                              ...
                              if (answersToUpdate[questionId]) {
                                (answersToUpdate[questionId].pointsBasedScoreInParent = questionPointsBasedScore),
                                  (answersToUpdate[questionId].scoreAchieved =
                                    scoreOfAllQuestionInCriteria[questionId].scoreAchieved),
                                  (answersToUpdate[questionId].weightage =
                                    scoreOfAllQuestionInCriteria[questionId].weightage);
                              } else {
                              ...
                              allCriteriaQuestions[
                                scoreOfAllQuestionInCriteria[questionId].questionIndexInArray
                              ].pointsBasedScoreInParent = questionPointsBasedScore;
                            });
                        ...
                        if (
                          questionOrCriteriaArray.findIndex((questionOrCriteria) =>
                            _.includes(questionOrCriteria, 'countOfAllQuestionInCriteria'),
                          ) >= 0
                        ) {
                          result = 0;

                          let criteriaIdIndex = questionOrCriteriaArray.findIndex(
                            (questionOrCriteria) => !_.includes(questionOrCriteria, 'countOfAllQuestionInCriteria'),
                          );
                          let criteriaId = questionOrCriteriaArray[criteriaIdIndex];
                          if (criteriaIdIndex < 0) {
                            return 'NA';
                          ...
                          let criteriaQuestionFunctionIndex = questionOrCriteriaArray.findIndex((questionOrCriteria) =>
                            _.includes(questionOrCriteria, 'countOfAllQuestionInCriteria'),
                          );
                          ...
                          if (criteriaQuestionFilter[1]) {
                            ...
                            allCriteriaQuestions.forEach((question) => {
                              ...
                              for (
                                let pointerToConditionArray = 0;
                                pointerToConditionArray < conditionArray.length;
                                pointerToConditionArray++
                              ) {
                                ...
                                for (
                                  let pointerToAllPossibleValuesArray = 0;
                                  pointerToAllPossibleValuesArray < allPossibleValues.length;
                                  pointerToAllPossibleValuesArray++
                                ) {
                                  const eachValue = allPossibleValues[pointerToAllPossibleValuesArray];
                                  if (
                                    questionMatchOperator == '==' &&
                                    _.isEqual(question[eachConditionArray[0]], eachValue)
                                  ) {
                                ...
                                if (singleConditionOperator == '||' && conditionValueMatch > 0) {
                                  ...
                                  (singleConditionOperator == '&&' || singleConditionOperator == '') &&
                                  conditionValueNotMatch <= 0
                                ) {
                                  conditionMatch += 1;
                                } else {
                                  conditionNotMatch += 1;
                              ...
                              if (multipleConditionOperator == 'OR' && conditionMatch > 0) {
                                ...
                                (multipleConditionOperator == 'AND' || multipleConditionOperator == '') &&
                                conditionNotMatch <= 0
                              ) {
                                tempAllQuestion.push(question);
                              }
                          ...
                          allCriteriaQuestions.forEach((question) => {
                            if (
                              question[_.head(criteriaQuestionFilter[0].split('='))] &&
                              question[_.head(criteriaQuestionFilter[0].split('='))] ==
                                _.last(criteriaQuestionFilter[0].split('='))
                            ) {
                              result += 1;
                            }
                          });
                        ...
                        eachSubmissionDocument.answers[questionOrCriteriaArray[0]] &&
                        ...
                        inputTypes.forEach((inputType) => {
                          if (questionOrCriteriaArray[1] === inputType) {
                            if (
                              eachSubmissionDocument.answers[questionOrCriteriaArray[0]] &&
                              (!eachSubmissionDocument.answers[questionOrCriteriaArray[0]].notApplicable ||
                                eachSubmissionDocument.answers[questionOrCriteriaArray[0]].notApplicable != true) &&
                              (eachSubmissionDocument.answers[questionOrCriteriaArray[0]][inputType] ||
                                eachSubmissionDocument.answers[questionOrCriteriaArray[0]][inputType] == 0)
                            ) {
                      ...
                      Object.keys(criteria.rubric.expressionVariables).forEach((variable) => {
                        if (variable != 'default') {
                          expressionVariables[variable] = questionAndCriteriaValueExtractor(
                            criteria.rubric.expressionVariables[variable],
                          );
                          expressionVariables[variable] =
                            expressionVariables[variable] === 'NA' &&
                            criteria.rubric.expressionVariables.default &&
                            criteria.rubric.expressionVariables.default[variable]
                              ? criteria.rubric.expressionVariables.default[variable]
                              : expressionVariables[variable];
                      ...
                      result.criteria[criteria.externalId].expressionVariablesDefined =
                      ...
                      if (score == 'NA') {
                        ...
                        if (criteria.rubric.levels[score]['improvement-projects']) {
                          criteria['improvement-projects'] = criteria.rubric.levels[score]['improvement-projects'];
                        }
                      ...
                      if (eachSubmissionDocument.scoringSystem == messageConstants.common.POINTS_BASED_SCORING_SYSTEM) {
                        ...
                        submissionAnswers.forEach((answer) => {
                          if (answer.pointsBasedScoreInParent)
                            criteria.pointsBasedScoreOfAllChildren += answer.pointsBasedScoreInParent;
                        });
                      }
              ...
              if (
                result.runUpdateQuery &&
                eachSubmissionDocument.scoringSystem == messageConstants.common.POINTS_BASED_SCORING_SYSTEM &&
                eachSubmissionDocument.themes &&
                eachSubmissionDocument.themes.length > 0
              ) {
                    ...
                    criteriaData.forEach((criteria) => {
                      if (themes.criteriaToUpdate[criteria._id.toString()]) {
                        Object.keys(themes.criteriaToUpdate[criteria._id.toString()]).forEach((criteriaKeyToUpdate) => {
                          criteria[criteriaKeyToUpdate] =
                            themes.criteriaToUpdate[criteria._id.toString()][criteriaKeyToUpdate];
                        });
                      }
                    });
                  }
                    ...
                    if (Object.keys(answersToUpdate[questionId]).length > 0) {
                      Object.keys(answersToUpdate[questionId]).forEach((answerField) => {
                        ...
                        if (answerField != 'value' || answerField != 'payload') {
                          updateObject.$set[`answers.${questionId}.${answerField}`] =
                            answersToUpdate[questionId][answerField];
                        }
                      });
                    }
                  });
                  if (updateObject.$set.pointsBasedMaxScore > 0 && updateObject.$set.pointsBasedScoreAchieved > 0) {
                    updateObject.$set.pointsBasedPercentageScore =
                      (updateObject.$set.pointsBasedScoreAchieved / updateObject.$set.pointsBasedMaxScore) * 100;
                  } else {
                    updateObject.$set.pointsBasedPercentageScore = 0;
                  }
                }

                let submissionModel = eachSubmissionDocument.submissionCollection
                  ? eachSubmissionDocument.submissionCollection
                  : 'submissions';
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        for (let pointerToThemeArray = 0; pointerToThemeArray < themesWithRubric.length; pointerToThemeArray++) {
          ...
          themeByHierarchyLevel[theme.hierarchyLevel]
            ? themeByHierarchyLevel[theme.hierarchyLevel].push(theme)
            : (themeByHierarchyLevel[theme.hierarchyLevel] = [theme]);
        }
        ...
        if (Object.keys(themeByHierarchyLevel).length > 0) {
          while (maxThemeDepth >= 0) {
            if (themeByHierarchyLevel[maxThemeDepth]) {
              let themeData = await Promise.all(
                themeByHierarchyLevel[maxThemeDepth].map(async (theme) => {
                    ...
                    if (theme.rubric.expressionVariables && allThemeLevelExpressions) {
                      ...
                      const subThemeValueExtractor = function (subTheme) {
                        ...
                        if (subThemeArray.findIndex((theme) => _.includes(theme, 'sumOfPointsOfAllChildren')) >= 0) {
                          ...
                          let themeExternalIdIndex = subThemeArray.findIndex(
                            (theme) => !_.includes(theme, 'sumOfPointsOfAllChildren'),
                          );
                          ...
                          theme.criteria.forEach((themeCriteria) => {
                            if (themeCriteria.weightage > 0) {
                              if (criteriaMap[themeCriteria.criteriaId.toString()]) {
                                theme.criteriaLevelCount[criteriaMap[themeCriteria.criteriaId.toString()].score]
                                  ? (theme.criteriaLevelCount[
                                      criteriaMap[themeCriteria.criteriaId.toString()].score
                                    ] += 1)
                                  : (theme.criteriaLevelCount[
                                      criteriaMap[themeCriteria.criteriaId.toString()].score
                                    ] = 1);
                              ...
                              if (!theme.immediateChildren && criteriaMap[themeCriteria.criteriaId.toString()]) {
                                scoreOfAllSubthemeInTheme[themeCriteria.criteriaId.toString()] = {
                                  ...
                                  pointsBasedScoreOfAllChildren:
                                    criteriaMap[themeCriteria.criteriaId.toString()].pointsBasedScoreOfAllChildren,
                          ...
                          Object.keys(scoreOfAllSubthemeInTheme).length > 0 &&
                            Object.keys(scoreOfAllSubthemeInTheme).forEach((subThemeKey) => {
                              result +=
                                (scoreOfAllSubthemeInTheme[subThemeKey].pointsBasedScoreOfAllChildren *
                                  scoreOfAllSubthemeInTheme[subThemeKey].weightage) /
                                totalWeightOfSubthemeInTheme;
                              ...
                              scoreOfAllSubthemeInTheme[subThemeKey].pointsBasedScoreInParent =
                                (scoreOfAllSubthemeInTheme[subThemeKey].pointsBasedScoreOfAllChildren *
                                  scoreOfAllSubthemeInTheme[subThemeKey].weightage) /
                                totalWeightOfSubthemeInTheme;
                      ...
                      Object.keys(theme.rubric.expressionVariables).forEach((variable) => {
                        if (variable != 'default') {
                          expressionVariables[variable] = subThemeValueExtractor(
                            theme.rubric.expressionVariables[variable],
                          );
                          expressionVariables[variable] =
                            expressionVariables[variable] === 'NA' &&
                            theme.rubric.expressionVariables.default &&
                            theme.rubric.expressionVariables.default[variable]
                              ? theme.rubric.expressionVariables.default[variable]
                              : expressionVariables[variable];
                          if (expressionVariables[variable] === 'NA') {
                            allValuesAvailable = false;
