...
module.exports = class StaticLinksHelper {
  ...
  static staticLinksDocuments(staticLinksFilter = 'all', fieldsArray = 'all', skipFields = 'none') {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        let staticLinkData = await database.models.staticLinks.find(queryObject, projection).lean();
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        if (appSpecificQuery.appType && appSpecificQuery.appName) {
          appSpecificStaticLinks = await this.staticLinksDocuments(appSpecificQuery, projection);
        }
        ...
        let commonStaticLinks = await this.staticLinksDocuments(commonSpecificQuery, projection);
