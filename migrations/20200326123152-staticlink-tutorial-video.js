module.exports = {
  async up(db) {
    ...
    await db
      .collection('staticLinks')
      .updateMany(
        {},
        {
          $set: {
            appType:
              process.env.MOBILE_APPLICATION_APP_TYPE && process.env.MOBILE_APPLICATION_APP_TYPE != ''
                ? process.env.MOBILE_APPLICATION_APP_TYPE
                : 'assessment',
          },
        },
      );
    ...
    return await db.collection('staticLinks').insertMany([tutorialVideoLink]);
  },
