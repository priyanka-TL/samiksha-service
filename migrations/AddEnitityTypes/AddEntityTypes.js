...
(async () => {
  ...
  try {
    ...
    let blockEntity = {
      ...
      profileFields: ['name', 'blockId', 'districtName', 'state', 'region'],
      profileForm: [],
      createdAt: new Date(),
      updatedAt: new Date(),
      createdBy: 'SYSTEM',
    ...
    let districtEntity = {
      ...
      profileFields: [],
      profileForm: ['name', 'state', 'districtId', 'region'],
      createdAt: new Date(),
      updatedAt: new Date(),
      createdBy: 'SYSTEM',
      updatedBy: 'SYSTEM',
    ...
    let stateEntity = {
      ...
      profileFields: ['externalId', 'name', 'region', 'capital'],
      profileForm: [],
      createdAt: new Date(),
      updatedAt: new Date(),
      createdBy: 'SYSTEM',
    ...
    let talukEntity = {
      ...
      profileFields: ['externalId', 'name', 'district', 'state'],
      profileForm: [],
      createdAt: new Date(),
      updatedAt: new Date(),
      createdBy: 'SYSTEM',
    ...
    let regionEntity = {
      ...
      profileFields: ['externalId', 'name', 'state'],
      profileForm: [],
      createdAt: new Date(),
      updatedAt: new Date(),
      createdBy: 'SYSTEM',
    ...
    let complexEntity = {
      ...
      profileFields: ['externalId', 'name', 'mandal', 'district', 'state'],
      profileForm: [],
      createdAt: new Date(),
      updatedAt: new Date(),
      createdBy: 'SYSTEM',
