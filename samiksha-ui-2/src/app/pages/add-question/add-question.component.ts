...
export class AddQuestionComponent implements OnInit {
  ...
  reset() {
    let self = this;
    this.apiService.reqHandler('getCriteriaAndQuestion', undefined).then((result) => {
    ...
    this.evidences = [
      {
        ...
        description:
          'Give the school leader the list of documents to be kept ready, and once they are given - begin the analysis',
        startTime: '',
        endTime: '',
        isSubmitted: false,
        sections: [],
      ...
      },
      {
        ...
        description:
          'Conduct teacher interviews for 25% of teachers across sections or 10 teachers, whichever is greater',
        startTime: '',
        endTime: '',
        isSubmitted: false,
        sections: [],
      ...
      },
      {
        ...
        description:
          'Approach parents when they are dropping children to the school or are waiting to pick children up from the school. Ask the following questions for 7-8 parents',
        startTime: '',
        endTime: '',
        isSubmitted: false,
        sections: [],
