              ...
              questions: [
                {
                  _id: 'QIDA01',
                  externalId: 'LW/SS/01',
                  question: ['Are there any unnamed bottles lying around that may be harmful ? '],
                ...
                },
                {
                  ...
                  options: [
                    ...
                    {
                      value: 'R3',
                      label: 'Antiseptic liquid such as Dettol / Betadine/ spirit',
                    },
                    {
                      value: 'R4',
                      label: 'Antiseptic ointment/ cream/ powder such as betadine, povidone/ iodine',
                    },
                    {
                      value: 'R5',
                      label: 'Thermometer First aid box is incomplete and contents are expired',
                    },
                  ],
                  validation: {
                    required: true,
              ...
              questions: [
                {
                  _id: 'QIDA03',
                  externalId: 'BL/TL',
                  question: ['What is the date of last white wash / painting of whole school?'],
                  tip: 'Some tip at question level.',
                  responseType: 'date',
                  value: '',
                  isCompleted: false,
