...
export class CriteriaComponent implements OnInit {
  ...
  saveCriteria() {
    ...
    localStorage.setItem('evidencesSelected', JSON.stringify(this.evidencesSelected));
    localStorage.setItem('sectionsSelected', JSON.stringify(this.sectionsSelected));
  ...
  resetCriteria() {
    ...
    ['criteria', 'questions', 'evidencesSelected', 'sectionsSelected', 'levelsSelected'].forEach((key) => {
